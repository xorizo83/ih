...
const tips1 =[
 "bypass all but need premium proxy",
 "Buy Method? @F0CK3T",
];
...
{ "CF-Visitor": '{"scheme":"https"}' }, 
 ...
 if (cluster.isMaster) {
    console.clear()
    console.log(`--------------------------------------------`.gray)
    console.log(`Target: `.blue + process.argv[2])
    console.log(`Time: `.blue + process.argv[3])
    console.log(`Rate: `.blue + process.argv[4])
    console.log(`Thread: `.blue + process.argv[5])
    console.log(`ProxyFile: `.blue + process.argv[6])
    console.log(`--------------------------------------------`.gray)
